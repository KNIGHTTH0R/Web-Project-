...
$articles = array() ;
$query= $link->query(" SELECT COUNT(*) as count,  articles.id, articles.title, AVG(articles_ratings.rating) AS rating 
	FROM  articles
	INNER JOIN articles_ratings
	ON articles.id=articles_ratings.articles AND articles.Product_Type='bedsandhardbord'
